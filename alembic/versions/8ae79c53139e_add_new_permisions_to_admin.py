...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            {'role_id': 1, 'right_id': 1, 'goal_id': 10, 'can_grant': True},
            {'role_id': 1, 'right_id': 3, 'goal_id': 10, 'can_grant': True},
            {'role_id': 1, 'right_id': 1, 'goal_id': 11, 'can_grant': True},
            {'role_id': 1, 'right_id': 3, 'goal_id': 11, 'can_grant': True},
        ]
    )
