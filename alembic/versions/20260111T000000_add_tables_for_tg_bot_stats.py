...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_tg_event_types_id"), "tg_event_types", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_tg_event_types_name"), "tg_event_types", ["name"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_tg_events_event_type_id"), "tg_events", ["event_type_id"], unique=False
    )
