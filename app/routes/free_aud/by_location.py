"""Эндпоинт поиска свободных аудиторий по локации (кампусу)."""
...
def register_endpoint(router: APIRouter):
    """
    Регистрирует эндпоинт `/by-loc` (Swagger tag `free-aud`).
    ...
    async def by_loc(
        ...
        """
        Возвращает свободные аудитории для выбранной локации (кампуса).

        Args:
            response: Объект Response для управления статусом.
            db: Асинхронная сессия SQLAlchemy.
            filter_: Параметры фильтрации (локация, день, пара).
