"""Поиск свободных аудиторий по локации кампуса."""
...
from app.models import Location, Type
...
def register_endpoint(router: APIRouter):
    ...
    async def by_location(
        ...
        """Возвращает свободные аудитории по локации."""
        if globals_.locker:
